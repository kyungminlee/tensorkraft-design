...
impl<T: Scalar, Q: QuantumNumber> MPS<T, Q, BondCentered> {
...
pub enum InitialSubspace<'a, T: Scalar> {
    ...
    /// The solver takes ownership and continues expanding from this basis.
...
#### 10.2.1 Stream-Aware DAG Execution
...
pub struct DeviceLocation {
    ...
    pub sync_event: Option<cuda::Event>,  // signaled when this node's output is ready
}
...
#### 10.2.2 GPU Performance Considerations
...
| TDVP projector-splitting vs typestates | Medium | BondCentered typestate exposes singular value matrices for backward time evolution; clean transitions to/from MixedCanonical |
